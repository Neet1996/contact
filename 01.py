...
||=========================||
   By:✍ŦɛşŦ ƅ✪Ŧ Îℕƿ¥➣➤
  By project : นายเอ็มเรื่อยเปื่อย              
"""

Thaihelp ="""\n
    ===✒️ ชุดคำสั่ง Maid Bot ✒️ ===
...
Bots = [mid,"u6b4952a264bc2571f5c02a54442808f1"]
bot1 = cl.getProfile().mid
admsa = "uf6c337b7dc57d24351b192caf612b812"
admin = "u6b4952a264bc2571f5c02a54442808f1"
...
def bot(op):
    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u6b4952a264bc2571f5c02a54442808f1":
                    if "join:" in msg.text:
...
#--------------------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Protect on on 􀜁􀇔􏿿👈")
                    else:
                        cl.sendText(msg.to,"Already on")
                else:
                    wait["linkprotect"] = True
    ...
    #--------------- SC Add Admin ---------
              ...
              _name = msg.text.replace("เพิ่มแอด @","")
              ...
              if targets == []:
                ...
                for target in targets:
                  try:
                    admin.append(target)
                    cl.sendText(msg.to,"Admin เพิ่มเรียบร้อยแล้ว")
                  except:
                    pass
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Admin ลบเรียบร้อยแล้ว")
                        except:
                            pass
            ...
            elif msg.text in ["ดูรายชื่อแอดมิน"]:
              if admin == []:
                  cl.sendText(msg.to,"The stafflist is empty")
              else:
                  cl.sendText(msg.to,"กำลังดูให้...")
                  mc = "||Admin Maid Bot||\n=====================\n"
                  for mi_d in admin:
...
#----------------------ADMIN COMMAND------------------------------#
              ...
              if msg.from_ in admin:
                    ...
                    if msg.from_ in admin:
                        ...
                        for g in gs.members:
                            if _nametarget == g.displayName:
                                targets.append(g.mid)
                        if targets == []:
                            cl.sendText(msg.to, "ทุกคน ก๊อปปี้ไม่สำเร็จ")
                        else:
                            for target in targets:
                                try:
                                    cl.cloneContactProfile(target)
                ...
                try:
                    ...
                    ki.sendText(msg.to, "ทุกคน กลับร่างเดิมแล้ว")
                except Exception as e:
            ...
            elif msg.text == "ลิ้งเว็บ":
                    ki.sendText(msg.to,"google.com")
                ...
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        try:
                            ...
                            pass
            elif "ล้างบาง" in msg.text:
              if msg.from_ in admin:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("ล้างบาง","")
                    gs = ki.getGroup(msg.to)
                    gs = ki2.getGroup(msg.to)
...
#-----------------------------------------------
            elif msg.text in ["คิกมา","มามะ","เด็กๆ","โม่ๆ","เข้า"]:
                if msg.from_ in admin:
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = False
...
#-----------------------------------------------
                        ...
                        k5.updateGroup(G)
#-----------------------------------------------
            elif msg.text in ["See you","Bye","กุเกลียดมึง","ออก","คิกออก"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
